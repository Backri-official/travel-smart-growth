    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        ...
        >
          ...
          {totalItems > 0 && (
            <Badge className="absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full p-0 flex items-center justify-center text-[10px] bg-primary text-primary-foreground">
              {totalItems}
            </Badge>
          )}
        </Button>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold">
                    {formatPrice(
                      ...
                      items[0]?.price.currencyCode || "AED",
                    )}
                  </span>
                </div>
                <Button
